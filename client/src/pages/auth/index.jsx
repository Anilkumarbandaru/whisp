...
const Auth = () => {
  ...
  return (
      <div className='h-[100vh] w-[100vw] flex items-center justify-center'>
          <div className='h-[80vh] bg-white border-2 border-white text-opacity-90 shadow-2xl w-[80vw] md:w-[90vw] lg:w-[70vw] 
                  ...
                  <div className="flex items-center justify-center w-full">
                    <Tabs className="w-3/4">
                        ...
                        <TabsContent className="flex flex-col gap-5 " value="signup">
                            <Input placeholder="Email" type="email" className="rounded-full p-6" value={email} onChange={(e) => setEmail(e.target.value)} />
                            <Input placeholder="Password" type="password" className="rounded-full p-6" value={email} onChange={(e) => setPassword(e.target.value)} />
                            <Input placeholder="Confirm Password" type="text" className="rounded-full p-6" value={email} onChange={(e) => setConfirmPassword(e.target.value)} />
